...
<head>
    ...
    <link href="<?= base_url('assets/'); ?>css/focus.css" rel="stylesheet">
    <link href="<?= base_url('assets/'); ?>css/lib/data-table/buttons.bootstrap.css" rel="stylesheet" />
    <link href="<?= base_url('assets/'); ?>css/lib/data-table/datatables.css" rel="stylesheet" />
