<!-- page -->
<div id="carouselExampleCaptions" class="carousel slide p-t-5" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= base_url('assets/'); ?>img/WhatsApp Image 2022-12-30 at 13.19.07.jpeg" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
            <img src="<?= base_url('assets/'); ?>img/sindang_palay.png" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="<?= base_url('assets/'); ?>img/WhatsApp Image 2022-12-30 at 13.32.37.jpeg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
